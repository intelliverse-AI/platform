   ...
   <div>
    ...
    <main>
            <section class="banner">
                ...
                <div class="bn-img">
                    <img src="/images/hero-illo@3x.png" alt="Lawyers">
                </div>
            </section>
                ...
                <div class="updates-contain container">
                    ...
                    <div class="updates-btm">
                        <div class="update-card">
                            <div class="top-info">
                                <h2>US Accidents (2016 - 2023)</h2>
                                <img src="/images/dataset-thumbnail.jpg" alt="AfroAI Innovate">
                            </div>
                            <div class="btm-info">
                                <span class="status">Usability <strong>10.0</strong> · 685 MB</span>
                                <p>An up-to-date dataset of over 40,000 international football results</p>
                            </div>
                        </div>
                        <div class="update-card">
                            <div class="top-info">
            ...
            <section class="hiworks">
                <img class="hiwork-back-images one" src="/images/illo-about-left.png" alt="afroaiinnovate">
                <div class="hiworks-holder container">
                    <div class="hiworks-head">
                        <p class="top">HOW IT WORKS</p>
                        <h2 class="heading">Let us guide you to the right path</h2>
                        <p class="btm">Browse all content by practice area.</p>
                    </div>
                ...
                <img class="hiwork-back-images two" src="/images/illo-about-right.png" alt="afroaiinnovate">
            </section>
